...
void BoostFlightPaths::UnlockFlightPaths(Player *player, uint8 continent)
{
  if (continent == BOOST_FLIGHTPATHS_EASTERN_KINGDOMS)
  {
  ...
  else if (continent == BOOST_FLIGHTPATHS_KALIMDOR)
  {
  ...
  else if (continent == BOOST_FLIGHTPATHS_OUTLAND)
  {
  ...
  else if (continent == BOOST_FLIGHTPATHS_NORTHEND)
  {
